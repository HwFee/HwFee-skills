...
1. Run the script by absolute path.
   Completion criterion: 命令使用 `C:\Users\17445\.agents\skills\image2-gen\generate.ps1`，不是 workspace-relative 路径。
...
```powershell
powershell -ExecutionPolicy Bypass -File "C:\Users\17445\.agents\skills\image2-gen\generate.ps1" -Prompt "a red apple on white table" -Output "./out.png"
```
